...
export default function DataGuru() {
  ...
  const handleExportCSV = () => {
    ...
    const headers = ['No', 'Jenjang', 'Jenis Prestasi', 'Nama Madrasah', 'NSM', 'Nama Guru', 'L/P', 'Prestasi', 'Ket. Prestasi', 'Detail Pencapaian', 'Tingkat', 'Tanggal', 'Penyelenggara', 'Sertifikat'];
